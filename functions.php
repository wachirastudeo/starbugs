...
function wp_theme_setup() {
	 ...
	 */
	 register_nav_menus( array(
		...
		'about' => __( 'About Sitemap', 'wp-theme-prototype' ),
		'story' => __( 'Story Sitemap', 'wp-theme-prototype' ),
		'sitemap' => __( 'Sitemap Sitemap', 'wp-theme-prototype' ),
...
add_action('init', 'new_product_taxonomy', 0)
?>
